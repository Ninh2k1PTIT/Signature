...
export class AppComponent {
  ...
  public change(): void {
    let saveBtn: SplitButton = getComponent(
      document.getElementById('save-option')!,
      'split-btn'
    );
  ...
  public onCreate(e: any) {
    ...
    let strokeColor: ColorPicker = new ColorPicker({
      ...
      change: (args: ColorPickerEventArgs) => {
        ...
        let selElem: HTMLElement =
          strokeColor.element.nextElementSibling?.querySelector(
            '.e-selected-color'
          ) as HTMLElement;
    ...
    let bgColor: ColorPicker = new ColorPicker({
      ...
      change: (args: ColorPickerEventArgs) => {
        ...
        let selElem: HTMLElement =
          bgColor.element.nextElementSibling?.querySelector(
            '.e-selected-color'
          ) as HTMLElement;
    ...
    addClass(
      [bgColor.element.nextElementSibling?.querySelector('.e-selected-color')!],
      'e-sign-icons'
    );
    document
      .getElementById('save-option')
      ?.addEventListener('click', this.saveBtnClick);
    this.clearButton();
